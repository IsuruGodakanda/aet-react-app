...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'logo-sign': "url('./assets/images/logo-sign.png')",
        'logo-hor': "url('./assets/images/logo-hor.png')",
      },
      boxShadow: {
        primaryBoxShadow: '0px 4px 7px 0px rgba(219, 219, 219, 1)',
      },
    },
    screens: {
      sm: '640px',
